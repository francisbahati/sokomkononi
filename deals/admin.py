...
class OfferAdmin(admin.ModelAdmin):
    list_display = ('id', 'deal_room', 'made_by', 'amount', 'status', 'created_at')
    list_filter = ('status', 'created_at')
    search_fields = ('deal_room__listing__title', 'made_by__username')
    list_editable = ('status',)


@admin.register(DealRoom)
class DealRoomAdmin(admin.ModelAdmin):
    list_display = ('id', 'listing_link', 'buyer_link', 'seller_link', 'status_badge', 'final_price_display', 'created_at')
    list_filter = ('status', 'created_at')
    search_fields = ('listing__title', 'buyer__username', 'seller__username', 'listing__listing_id')
    ...
    fieldsets = (
        ...
        ('Pricing', {
            'fields': ('original_price', 'buyer_offer', 'seller_counter', 'final_price', 'commission_amount')
        }),
        ('Status', {
    ...
    def mark_as_completed(self, request, queryset):
        ...
        self.message_user(request, f'{queryset.count()} deals marked as completed.')
