...
class ListingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_featured', 'main_image', 'view_count', 'seller', 'seller_details',
            'verified_by', 'created_at', 'updated_at', 'verified_at',
            'primary_image', 'images', 'images_count'
        ]
        read_only_fields = [
...
class ListingCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        validated_data['status'] = Listing.Status.PENDING  # Needs admin verification
